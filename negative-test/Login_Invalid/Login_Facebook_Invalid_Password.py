...
class LoginFacebookInvalidPassword(unittest.TestCase):
	def setUp(self):
	...
	def test_login_facebook_invalid_password(self):
		...
		driver.find_element_by_id("email").send_keys("irwansyarifudin@yahoo.com")
		time.sleep(3)
		
		driver.find_element_by_id("pass").click()
		driver.find_element_by_id("pass").send_keys("91xxxhh9")
		time.sleep(5)
		...
		if error_box.is_displayed():
			print("The inputted password is not registered")
