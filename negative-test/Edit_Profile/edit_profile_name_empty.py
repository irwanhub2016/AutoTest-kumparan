...
class EditProfileNameEmpty(unittest.TestCase):
	def setUp(self):
	...
	def test_edit_profile_name_empty(self):
		...
		if element_gmail.is_displayed():
			...
			driver.find_element_by_xpath("(.//*[@id='content']/div/div/div[3]/div/div/div/div/div[1]/div/div[2]/div[3]/div/div/div/div/input)").click()
			driver.find_element_by_xpath("(.//*[@id='content']/div/div/div[3]/div/div/div/div/div[1]/div/div[2]/div[3]/div/div/div/div/input)").clear()
			time.sleep(3)
