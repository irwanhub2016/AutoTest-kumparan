...
class EditProfileWithoutSetGender(unittest.TestCase):
	...
	def test_edit_profile_without_set_gender(self):
		...
		if element_gmail.is_displayed():
			...
			driver.find_element_by_xpath("(.//*[@id='content']/div/div/div[3]/div/div/div/div/div[1]/div/div[2]/div[10]/div/div/div/div/input)").click()
			driver.find_element_by_xpath("(.//*[@id='content']/div/div/div[3]/div/div/div/div/div[1]/div/div[2]/div[10]/div/div/div/div/input)").clear()
			phone_number = '08axx-!@'
			driver.find_element_by_xpath("(.//*[@id='content']/div/div/div[3]/div/div/div/div/div[1]/div/div[2]/div[10]/div/div/div/div/input)").send_keys(phone_number)
			time.sleep(5)
			...
			if alert_notif.text == 'Maaf, Terjadi galat. Perubahan anda tidak berhasil di simpan':
