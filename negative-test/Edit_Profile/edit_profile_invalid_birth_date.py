...
class EditProfileInvalidBirthDate(unittest.TestCase):
	def setUp(self):
	...
	def test_edit_profile_invalid_birth_date(self):
		...
		if element_gmail.is_displayed():
			...
			driver.find_element_by_xpath(
				"(.//*[@id='content']/div/div/div[1]/div/nav/div/div[2]/div[3]/div/div/a/span/div/span/div)").click()
			time.sleep(3)
			
			driver.find_element_by_xpath(
				"(.//*[@id='content']/div/div/div[3]/div/div/div/div/div[1]/div/div/div/div[2]/div/div/a[2]/div[2]/div/div/div/span)").click()
			time.sleep(3)
			
			driver.find_element_by_xpath(
				"(.//*[@id='content']/div/div/div[3]/div/div/div/div/div[1]/div/div[2]/div[9]/div/div/div/div/input )").click()
			driver.find_element_by_xpath(
				"(.//*[@id='content']/div/div/div[3]/div/div/div/div/div[1]/div/div[2]/div[9]/div/div/div/div/input )").clear()
			birth_date = '1996-823a!'
			driver.find_element_by_xpath(
				"(.//*[@id='content']/div/div/div[3]/div/div/div/div/div[1]/div/div[2]/div[9]/div/div/div/div/input )").send_keys(birth_date)
			time.sleep(5)
			
			driver.find_element_by_xpath(
				"(.//*[@id='content']/div/div/div[3]/div/div/div/div/div[1]/div/div[2]/div[11]/button/span/span)").click()
			time.sleep(3)
			
			alert_notif = driver.find_element_by_xpath(
				"(.//*[@id='content']/div/div/div[3]/div/div/div/div/div[1]/div/div[1]/div[2]/div/div/div/div[1]/div/span)")
			
			if alert_notif.text == 'Perubahan berhasil di simpan':
				print(
					"Should value Nama is mandatory (required)  or user get Notification appears 'Maaf, Terjadi galat. Perubahan anda tidak berhasil di simpan'")
				print("It's a bug.")
				
			else:
				print("Notification appears 'Perubahan berhasil di simpan'")
